...
class  calculator extends WindowAdapter implements ActionListener,FocusListener 
{
    JFrame f;
    Container con;
	JTextField t;
...
{
    JOptionPane.showMessageDialog(f,"welcome to calculator");
}
